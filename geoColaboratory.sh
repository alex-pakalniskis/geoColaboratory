...
if [ ! -f Miniconda3-4.5.4-Linux-x86_64.sh ]; then
    ...
    # install geoRAPIDS packages
        conda install -y --prefix /usr/local \
                ...
                dask-cudf \
                xgboost rasterstats geopandas descartes rasterio 
        ...
        echo "Installing geoRAPIDS $RAPIDS_VERSION packages from the stable release channel"
        echo "Please standby, this will take a few minutes..."
...
echo ""
echo "*********************************************"
echo "Your Google Colab instance is geoRAPIDS ready!"
echo "*********************************************"
